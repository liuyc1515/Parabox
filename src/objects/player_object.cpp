...
PlayerObject::PlayerObject(std::shared_ptr<const ObjectManager> object_manager, 
                ...
                std::shared_ptr<const std::map<uint64_t, std::shared_ptr<const BaseObject>>> objects) : BaseObject(OBJECT::PLAYER, object_manager, map_manager, objects) 
{

}

std::map<uint64_t, ACTION::Action> PlayerObject::Move(ACTION::Action act, MAP::MapID map_id) const
{
