...
BaseRecursionMap::BaseRecursionMap(int x, int y) : BaseMap() {
	x_ = x;
	y_ = y;
...
BaseRecursionMap::~BaseRecursionMap() {
}

void BaseRecursionMap::SetObject(const Coordinate &coord, OBJECT::ObjectType obj) {
...
Coordinate BaseRecursionMap::CalcCoordByAction(const Coordinate &coord, ACTION::Action act) const {
...
Coordinate BaseRecursionMap::GetVoidBorder(DIRECTION::Direction dir) const {
